...
SOCIAL_AUTH_STACKOVERFLOW_KEY = os.getenv('SOCIAL_AUTH_STACKOVERFLOW_KEY')
SOCIAL_AUTH_STACKOVERFLOW_SECRET = os.getenv('SOCIAL_AUTH_STACKOVERFLOW_SECRET')
SOCIAL_AUTH_STACKOVERFLOW_API_KEY = os.getenv('SOCIAL_AUTH_STACKOVERFLOW_API_KEY')
